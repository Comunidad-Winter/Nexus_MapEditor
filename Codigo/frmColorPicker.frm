...
Begin VB.Form frmColorPicker 
   ...
   Begin Nexus_MapEditor.lvButtons_H Command1 
      Height          =   375
      Left            =   1170
      TabIndex        =   26
      Top             =   4920
...
Private Sub Command1_Click()
    ...
    frmMapInfo.r1.Text = frmColorPicker.Text1(3).Text
    frmMapInfo.G1.Text = frmColorPicker.Text1(4).Text
    frmMapInfo.b1.Text = frmColorPicker.Text1(5).Text
    frmMapInfo.txtColor = RGB(Text1(3), Text1(4), Text1(5))
